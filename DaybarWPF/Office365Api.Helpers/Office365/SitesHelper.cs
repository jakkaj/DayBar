...
namespace Office365Api.Helpers.Office365
{
    public class  SitesHelper : BaseOffice365Helper
    {
        ...
        public async Task<IEnumerable<IItem>> GetDefaultDocumentFiles(string tenantUri, string siteUri)
        {
            ...
            // You can try the issue even using the easiest possible query
        ...
        public SharePointClient EnsureClientCreated(string tenantUri, string siteUri)
        {
            ...
            return new SharePointClient(
                ...
                async () =>
                {
                    return await this.AuthenticationHelper.GetAccessTokenForServiceAsync(tenantUri);
                });
        }
    }
}
